...
Таким образом, неэффективная реализация рандеву-каналов может привести к деградации производительности. В статье "Fast and Scalable Channels in Kotlin Coroutines"(Nikita Koval, Dan Alistarh, Roman Elizarov)`\cite{paper}`{=tex} предлагается эффективный алгоритм реализации рандеву-каналов с измерениями. 
